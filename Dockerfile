...
RUN cd polkadot_api_cpp && git fetch --all && git checkout sr25519code && git submodule init && git submodule update
RUN cd polkadot_api_cpp && cmake . && make sign_message && make transfer
